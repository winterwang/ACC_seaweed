...
.footnote[.bold[
- This meta-analysis evaluated iodine level measured by several types and we can see there is **no evidence for increased thyroid cancer risk** in any kind of measurements. 
...
With greater numbers of participants as well as cases that can be identified through ACC database, we propose to assess the association between seaweed intake and the risk of thyroid cancer in ACC for both men and women.
]]]]
